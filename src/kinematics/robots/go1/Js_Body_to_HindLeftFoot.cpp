...
static void output1(Eigen::Matrix<double,6,12> &p_output1, const Eigen::Matrix<double,12,1> &var1)
{
  ...
  p_output1(67)=t1121;
  p_output1(68)=t3206;
  p_output1(69)=0.213*t6202 - 0.1881*t6207 + t3206*(0. + t6177 + 0.1881*t3206*t6207) + t917*(0. + t3292 + 0.1881*t6207*t917);
  p_output1(70)=0. + 0.1881*t3206*t6202 + 0.213*t3206*t6207 + t3206*(0. + 0.1881*t6219);
  p_output1(71)=-0.1881*t6202*t917 - 0.213*t6207*t917 + (0. - 0.1881*t6219)*t917;
}
