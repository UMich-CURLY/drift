...
static void output1(Eigen::Matrix<double,6,12> &p_output1, const Eigen::Matrix<double,12,1> &var1)
{
  ...
  p_output1(31)=t1492;
  p_output1(32)=t1607;
  p_output1(33)=0.213*t6022 + 0.1881*t6027 + t118*(0. + t2003 - 0.1881*t118*t6027) + t1607*(0. + t6003 - 0.1881*t1607*t6027);
  p_output1(34)=0. - 0.1881*t1607*t6022 + 0.213*t1607*t6027 + t1607*(0. - 0.1881*t6039);
  p_output1(35)=0.1881*t118*t6022 - 0.213*t118*t6027 + t118*(0. + 0.1881*t6039);
  p_output1(36)=0;
  p_output1(37)=0.;
  p_output1(38)=0;
  p_output1(39)=0;
