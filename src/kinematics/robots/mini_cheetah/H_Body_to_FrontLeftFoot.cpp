...
#include "drift/kinematics/robots/mini_cheetah/H_Body_to_FrontLeftFoot.h"
...
static void output1(Eigen::Matrix<double, 4, 4>& p_output1,
  ...
  p_output1(11) = 0.;
  p_output1(12) = 0. + 0.19 * (1. - 1. * t668) + 0.19 * (t694 + t701)
                  - 0.4165 * (t735 + t739) + t668 * t761 - 1. * t697 * t766;
  p_output1(13) = 0. + 0.19 * (t711 + t715) + 0.049 * (1. - 1. * t718)
                  + 0.111 * t718 - 0.4165 * (t742 + t744)
                  - 1. * t697 * t703 * t761 - 1. * t668 * t703 * t766
                  - 1. * t703 * t778;
  p_output1(14) = 0. + 0.062 * t703 + 0.19 * (t721 + t722)
                  - 0.4165 * (t746 + t749) + t697 * t718 * t761
                  + t668 * t718 * t766 + t718 * t778;
  p_output1(15) = 1.;
}
