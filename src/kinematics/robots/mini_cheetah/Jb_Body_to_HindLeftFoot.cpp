...
#include "drift/kinematics/robots/mini_cheetah/Jb_Body_to_HindLeftFoot.h"
...
static void output1(Eigen::Matrix<double, 6, 12>& p_output1,
  ...
  p_output1(58) = 0. + t2146 * (0. + t2152 * t2172 + t2138 * t2179)
                  + t2138 * (0. - 1. * t2138 * t2172 - 1. * t2146 * t2179);
...
Eigen::Matrix<double, 6, 12> Jb_Body_to_HindLeftFoot(
    const Eigen::Matrix<double, 12, 1>& var1)
// void Jb_Body_to_HindLeftFoot(Eigen::Matrix<double,6,12> &p_output1, const
