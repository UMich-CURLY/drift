 ...
 * Fri 13 Nov 2020 16:04:58 GMT-05:00
 */
#include <math.h>
#include <stdio.h>
#include <stdlib.h>

#include "drift/kinematics/robots/mini_cheetah/Jwb_Body_to_HindLeftFoot.h"
...
static void output1(Eigen::Matrix<double, 3, 12>& p_output1,
  ...
  p_output1(25) = 0.;
  p_output1(26) = 0;
  p_output1(27) = 0. + t2150 * t2153 - 1. * t2161 * t2163;
  p_output1(28) = 0.;
  p_output1(29) = 0. - 1. * t2153 * t2161 - 1. * t2150 * t2163;
  p_output1(30) = 0.;
  p_output1(31) = -1.;
  p_output1(32) = 0.;
  p_output1(33) = 0.;
