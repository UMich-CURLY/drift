...
#include "drift/kinematics/robots/mini_cheetah/Jb_Body_to_FrontLeftFoot.h"
...
static void output1(Eigen::Matrix<double, 6, 12>& p_output1,
  ...
  p_output1(22) = 0. + t1910 * (0. + t1916 * t1936 + t1902 * t1943)
                  + t1902 * (0. - 1. * t1902 * t1936 - 1. * t1910 * t1943);
...
Eigen::Matrix<double, 6, 12> Jb_Body_to_FrontLeftFoot(
    const Eigen::Matrix<double, 12, 1>& var1)
// void Jb_Body_to_FrontLeftFoot(Eigen::Matrix<double,6,12> &p_output1, const
