...
#include "drift/kinematics/robots/mini_cheetah/H_Body_to_HindRightFoot.h"
...
static void output1(Eigen::Matrix<double, 4, 4>& p_output1,
  ...
  p_output1(11) = 0.;
  p_output1(12) = 0. - 0.19 * (1. - 1. * t1030) - 0.19 * (t1053 + t1058)
                  - 0.4165 * (t1089 + t1093) + t1030 * t1115
                  - 1. * t1056 * t1120;
  p_output1(13) = 0. - 0.19 * (t1067 + t1070) - 0.049 * (1. - 1. * t1072)
                  - 0.111 * t1072 - 0.4165 * (t1096 + t1098)
                  - 1. * t1056 * t1060 * t1115 - 1. * t1030 * t1060 * t1120
                  - 1. * t1060 * t1132;
  p_output1(14) = 0. - 0.062 * t1060 - 0.19 * (t1075 + t1076)
                  - 0.4165 * (t1100 + t1103) + t1056 * t1072 * t1115
                  + t1030 * t1072 * t1120 + t1072 * t1132;
  p_output1(15) = 1.;
}
