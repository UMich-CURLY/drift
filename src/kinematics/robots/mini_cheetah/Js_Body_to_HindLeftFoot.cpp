...
#include "drift/kinematics/robots/mini_cheetah/Js_Body_to_HindLeftFoot.h"
...
static void output1(Eigen::Matrix<double, 6, 12>& p_output1,
  ...
  p_output1(67) = t2195;
  p_output1(68) = t2206;
  p_output1(69) = -0.209 * t2228 - 0.19 * t2230
                  - 1. * t2188 * (0. + t2207 - 1. * t2188 * t2232)
                  - 1. * t2198 * (0. + t2212 - 1. * t2198 * t2232);
  p_output1(70) = 0. - 0.19 * t2198 * t2228 + 0.209 * t2198 * t2230
                  - 1. * t2198 * (0. + 0.19 * t2244);
  p_output1(71) = 0.19 * t2188 * t2228 - 0.209 * t2188 * t2230
                  - 1. * t2188 * (0. - 0.19 * t2244);
}
