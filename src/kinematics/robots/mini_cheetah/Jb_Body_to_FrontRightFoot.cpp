...
#include "drift/kinematics/robots/mini_cheetah/Jb_Body_to_FrontRightFoot.h"
...
static void output1(Eigen::Matrix<double, 6, 12>& p_output1,
  ...
  p_output1(4) = 0. + t2028 * (0. + t2034 * t2054 + t2020 * t2061)
                 + t2020 * (0. - 1. * t2020 * t2054 - 1. * t2028 * t2061);
...
Eigen::Matrix<double, 6, 12> Jb_Body_to_FrontRightFoot(
    const Eigen::Matrix<double, 12, 1>& var1)
// void Jb_Body_to_FrontRightFoot(Eigen::Matrix<double,6,12> &p_output1, const
