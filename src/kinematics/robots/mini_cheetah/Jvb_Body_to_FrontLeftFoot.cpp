...
#include "drift/kinematics/robots/mini_cheetah/Jvb_Body_to_FrontLeftFoot.h"
...
static void output1(Eigen::Matrix<double, 3, 12>& p_output1,
  ...
  p_output1(10) = 0. + t1985 * (0. - 1. * t1948 * t1982 - 1. * t1975 * t1985)
                  + t1948 * (0. + t1953 * t1975 + t1982 * t1985);
...
Eigen::Matrix<double, 3, 12> Jvb_Body_to_FrontLeftFoot(
    const Eigen::Matrix<double, 12, 1>& var1)
// void Jvb_Body_to_FrontLeftFoot(Eigen::Matrix<double,3,12> &p_output1, const
