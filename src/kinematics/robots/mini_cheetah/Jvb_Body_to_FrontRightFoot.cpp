...
#include "drift/kinematics/robots/mini_cheetah/Jvb_Body_to_FrontRightFoot.h"
...
static void output1(Eigen::Matrix<double, 3, 12>& p_output1,
  ...
  p_output1(1) = 0. + t2103 * (0. - 1. * t2066 * t2100 - 1. * t2093 * t2103)
                 + t2066 * (0. + t2071 * t2093 + t2100 * t2103);
