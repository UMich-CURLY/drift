...
#include "drift/kinematics/robots/mini_cheetah/Jvb_Body_to_HindRightFoot.h"
...
static void output1(Eigen::Matrix<double, 3, 12>& p_output1,
  ...
  p_output1(19) = 0. + t2339 * (0. - 1. * t2302 * t2336 - 1. * t2329 * t2339)
                  + t2302 * (0. + t2307 * t2329 + t2336 * t2339);
