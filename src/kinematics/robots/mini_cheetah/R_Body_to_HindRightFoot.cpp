...
#include "R_Body_to_HindRightFoot.h"
...
Eigen::Matrix<double,3,3> R_Body_to_HindRightFoot(const Eigen::Matrix<double,12,1> &var1)
//void R_Body_to_HindRightFoot(Eigen::Matrix<double,3,3> &p_output1, const Eigen::Matrix<double,12,1> &var1)
{
  /* Call Subroutines */
