...
#include "drift/kinematics/robots/mini_cheetah/R_Body_to_FrontRightFoot.h"
...
Eigen::Matrix<double, 3, 3> R_Body_to_FrontRightFoot(
    const Eigen::Matrix<double, 12, 1>& var1)
// void R_Body_to_FrontRightFoot(Eigen::Matrix<double,3,3> &p_output1, const
