...
#include "drift/kinematics/robots/mini_cheetah/Jb_Body_to_HindRightFoot.h"
...
static void output1(Eigen::Matrix<double, 6, 12>& p_output1,
  ...
  p_output1(40) = 0. + t2264 * (0. + t2270 * t2290 + t2256 * t2297)
                  + t2256 * (0. - 1. * t2256 * t2290 - 1. * t2264 * t2297);
...
Eigen::Matrix<double, 6, 12> Jb_Body_to_HindRightFoot(
    const Eigen::Matrix<double, 12, 1>& var1)
// void Jb_Body_to_HindRightFoot(Eigen::Matrix<double,6,12> &p_output1, const
