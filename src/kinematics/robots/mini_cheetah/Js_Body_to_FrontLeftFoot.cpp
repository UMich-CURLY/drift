...
#include "drift/kinematics/robots/mini_cheetah/Js_Body_to_FrontLeftFoot.h"
...
static void output1(Eigen::Matrix<double, 6, 12>& p_output1,
  ...
  p_output1(31) = t1959;
  p_output1(32) = t1970;
  p_output1(33) = -0.209 * t1992 + 0.19 * t1994
                  - 1. * t1952 * (0. + t1971 - 1. * t1952 * t1996)
                  - 1. * t1962 * (0. + t1976 - 1. * t1962 * t1996);
  p_output1(34) = 0. + 0.19 * t1962 * t1992 + 0.209 * t1962 * t1994
                  - 1. * t1962 * (0. - 0.19 * t2008);
  p_output1(35) = -0.19 * t1952 * t1992 - 0.209 * t1952 * t1994
                  - 1. * t1952 * (0. + 0.19 * t2008);
  p_output1(36) = 0;
  p_output1(37) = 0.;
  p_output1(38) = 0;
  p_output1(39) = 0;
