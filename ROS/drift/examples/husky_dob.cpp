...
int main(int argc, char** argv) {
  ...
  InekfEstimator inekf_estimator(
      error_type, project_dir + "/config/husky_dob/inekf_estimator.yaml");
  ...
  inekf_estimator.add_imu_dob_propagation(
      qimu, qimu_mutex,
      project_dir + "/config/husky_dob/imu_dob_propagation.yaml");

  inekf_estimator.add_velocity_dob_correction(
      qv, qv_mutex,
      project_dir + "/config/husky_dob/velocity_dob_correction.yaml");
