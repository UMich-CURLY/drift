#ifndef MEASUREMENT_TENSEGRITY_KINEMATICS_H
#define MEASUREMENT_TENSEGRITY_KINEMATICS_H

#include "measurement.h"

namespace measurement {
/**
 * @class TensegrityKinematicsMeasurement
 *
 * @brief Derived measurement class containing information
 * about body-to-foot kinematics
 */
class TensegrityKinematicsMeasurement : public Measurement {
 public:
  /// @name Constructors
  /**
   * @brief Default constructor, will generate an empty measurement.
   */
  TensegrityKinematicsMeasurement();
...
#endif    // MEASUREMENT_TENSEGRITY_KINEMATICS_H