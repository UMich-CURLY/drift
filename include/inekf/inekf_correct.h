...
class Correction {
 public:
  ...
  /// @name Constructors
  Correction(std::shared_ptr<sensor_data_t> sensor_data_buffer,
...
class KinematicsCorrection : public Correction {
 public:
  ...
  /// @name Constructors
  KinematicsCorrection(std::shared_ptr<sensor_data_t> sensor_data_buffer,
                       ErrorType error_type);
   ...
   *
   * @param[in] None
   * @return std::map<int,bool>: Map of contact ID and bool that indicates if
   * contact is registed
   */
   ...
   *
   * @param[in] None
   * @return std::map<int,int> map of contact ID and associated index in the
   * state matrix X
   */
   ...
   *
   * @param[in] contacts: A vector of contact ID and indicator pairs. A true
   * indicator means contact is detected.
   * @return None
   */
...
class VelocityCorrection : public Correction {
 public:
  ...
  /// @name Constructors
  VelocityCorrection(std::shared_ptr<sensor_data_t> sensor_data_buffer,
                     ErrorType error_type);
